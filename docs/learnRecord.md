...
- 2025-05-10：力扣-33-搜索旋转排序数组。
- 2025-05-11：力扣-153-寻找旋转排序数组的最小值。
- 2025-05-18：力扣-20-有效的括号。
- 2025-05-20：力扣-155-最小栈。
- 2025-05-29：使用CSS自定义属性实现主题切换。
- 2025-07-12：力扣-121-买卖股票的最佳时机。
- 2025-07-14：力扣-55-跳跃游戏。
- 2025-07-15：力扣-45-跳跃游戏 II。
- 2025-07-17：力扣-763-划分字母区间。
- 2025-07-18：力扣-70-爬楼梯。
- 2025-07-19：力扣-118-杨辉三角。
- 2025-07-20：力扣-198-打家劫舍。
- 2025-07-21：力扣-279-完全平方数。
- 2025-07-23：力扣-322-零钱兑换。
- 2025-07-24：力扣-139-单词拆分。
- 2025-07-26：力扣-300-最长递增子序列。
- 2025-07-31：力扣-62-不同路径。
- 2025-08-02：力扣-64-最小路径和。
- 2025-08-03：力扣-136-只出现一次的数字。
- 2025-08-04：力扣-169-多数元素。
...
**核心前端技术**：  
- 熟练使用 React 18+（Hooks/Virtual DOM/并发模式）、Vue 3（Composition API），熟悉状态管理（Redux Toolkit/Zustand/Pinia）、路由（React Router/Vue Router）；  
- 掌握 TypeScript（能定义复杂类型/泛型）、Webpack/Vite（配置优化、代码分割）、ES6+（Promise/async-await/解构赋值）；  
- 熟悉前端工程化（Git协作流程、ESLint/Prettier规范、CI/CD部署），了解 Node.js（Express/Koa写过简单接口/中间层）。  

**进阶能力**：  
- 性能优化：主导过首屏加载优化（LCP从3s→1.2s）、打包体积缩减（Webpack分包策略减少30%）、React渲染优化（Memo/useMemo减少无效更新）；  
- 跨端开发：有 Taro（React语法写小程序/H5多端适配）、Electron（桌面端应用）或 Uniapp 实践经验；  
- 新技术探索：了解 Web Components、微前端（qiankun）、AI辅助开发（如用GitHub Copilot写重复代码/调试）。

project：
性能优化（首屏时间FMP2.6s->1.8s，减少了30%；4种工具、10+种方法；）、DDD重构工程（根据设计方案快速生成领域模型以及类型定义；使用AI辅助编程生成接近10k行代码，提高开发效率30%；AI进行代码Review，优化显著的问题如判空、魔法值、提取工具方法、添加方法注释、完善错误捕获处理）、微信小程序地图和管理端高德地图。
...
- 利用Chrome NetWork、Performance以及lighthouse等工具分析首页性能优化点，通过splitChunks拆包、组件代码分割按需加载、移除sourceMap等方法，首屏FMP从2.6s降至1.8s，速度提高了约30%。
- 修改webapck配置，将sourceMap从js包中移除出来，包体积从1.1MB降低至500KB。
- 通过splitChunks拆包，将体积较大的包的部分内容拆分到别的包中，使所有包文件体积保持基本一致，保持在160KB左右，避免某个体积较大的包成为性能瓶颈。（476KB->200KB）
...
- 采用DDD领域驱动设计架构，基于 Taro + TypeScript + MobX 技术栈，对页面代码进行重构。
- 使用AI编辑器 Cursor 辅助编码，根据设计方案快速生成领域模型、TS类型定义等内容，提高开发效率约15%。（工期13->11）
- 利用AI进行代码Review，对一些基本问题及时检查修正，如判空、魔法值、提取重复代码等。
...
1. 地图显示与交互
高德地图集成：使用 @pansy/react-amap 组件显示地图
地图模式切换：支持普通地图和卫星地图模式切换
行政区域边界显示：根据用户当前项目显示行政区域电子围栏
地图点击事件处理：隐藏车辆标记弹窗信息
2. 车辆轨迹管理
GPS轨迹获取：从后端API获取车辆GPS轨迹数据
轨迹可视化：在地图上绘制车辆行驶轨迹线
轨迹回放动画：支持车辆沿轨迹移动的动画效果
起始/结束点标记：显示轨迹的起点和终点标记
3. 车辆位置信息
实时位置获取：获取车辆最后GPS位置信息
车辆标记显示：在地图上显示车辆图标
位置信息弹窗：鼠标悬停显示车辆详细信息（时间、车牌、速度、经纬度、地址）
4. 停车点管理
停车点识别：根据停车时长筛选停车点
停车点标记：在地图上显示停车点图标
停车点详情：点击停车点显示详细信息（位置、开始时间、结束时间、停车时长）
停车点列表：支持停车点列表展示和交互
5. 收运任务管理
收运点标记：显示收运任务点位置
任务状态显示：不同状态用不同图标表示（已收运、补卡、未收运、无法收）
任务详情弹窗：点击收运点显示任务详细信息
6. 时间筛选与查询
时间范围选择：支持选择查询的时间范围
停车时长设置：可设置停车时长阈值进行筛选
查询重置功能：支持重置查询条件
日切查询：根据系统配置的日切时间进行查询
7. 轨迹回放控制
播放控制：开始、暂停、重置动画
播放速度调节：支持0.5X、1X、5X、10X、16X等不同播放速度
播放状态管理：管理播放/暂停状态
8. 数据统计与分析
速度图表：显示车辆行驶速度变化图表
违规事件：显示车辆违规事件信息
...
9. 界面交互功能
工具栏折叠：支持工具栏的展开/收起
卡片式展示：任务、违规、速度图表、停车点等信息的卡片式展示
图层切换：地图/卫星图层切换
标记交互：各种标记的鼠标悬停、点击事件处理
10. 数据获取与处理
API数据获取：从多个后端接口获取数据
数据格式化：时间、距离、重量等数据的格式化显示
错误处理：API调用失败时的错误处理
11. 性能优化
覆盖物管理：及时清除旧的轨迹覆盖物
异步处理：位置信息解析的异步处理
...
http://jartto.wang/2020/03/30/about-web-fmp/#:~:text=%E5%9F%BA%E4%BA%8E%20Chromium%20%E7%9A%84%E5%AE%9E%E7%8E%B0%EF%BC%8C%E8%BF%99%E4%B8%AA%E7%BB%98%E5%88%B6%E6%98%AF%E4%BD%BF%E7%94%A8%20LayoutAnalyzer%20%E8%BF%9B%E8%A1%8C%E8%AE%A1%E7%AE%97%E7%9A%84%EF%BC%8C%E5%AE%83%E4%BC%9A%E6%94%B6%E9%9B%86%E6%89%80%E6%9C%89%E7%9A%84%E5%B8%83%E5%B1%80%E5%8F%98%E5%8C%96%EF%BC%8C%E5%BD%93%E5%B8%83%E5%B1%80%E5%8F%91%E7%94%9F%E6%9C%80%E5%A4%A7%E5%8F%98%E5%8C%96%E6%97%B6%E5%BE%97%E5%87%BA%E6%97%B6%E9%97%B4%E3%80%82%20%E5%85%B7%E6%9C%89%E6%9C%80%E5%A4%A7%E5%B8%83%E5%B1%80%E5%8F%98%E5%8C%96%E7%9A%84%E7%BB%98%E5%88%B6%E5%A6%82%E4%BD%95%E8%AE%A1%E7%AE%97%E5%91%A2%EF%BC%9F%20%E8%BF%98%E6%98%AF%E5%BE%88%E6%8A%BD%E8%B1%A1%EF%BC%8C%E6%88%91%E4%BB%AC%E7%BB%A7%E7%BB%AD%E6%8E%A2%E7%B4%A2%20LayoutAnalyzer%EF%BC%8C%E5%9C%A8%E6%BA%90%E7%A0%81%E4%B8%AD%E5%BE%97%E5%88%B0%E5%A6%82%E4%B8%8B%E5%85%AC%E5%BC%8F%EF%BC%9A,max%20%281%2C%20%E9%A1%B5%E9%9D%A2%E9%AB%98%E5%BA%A6%20%2F%20%E5%B1%8F%E5%B9%95%E9%AB%98%E5%BA%A6%29%20%E8%BF%99%E4%B8%8B%E6%B8%85%E6%99%B0%E4%BA%86%EF%BC%8C%E6%97%A2%E7%84%B6%E5%8F%AF%E4%BB%A5%E7%AE%97%E5%87%BA%E6%9D%A5%EF%BC%8C%E9%82%A3%E4%B9%88%E4%BC%98%E5%8C%96%20FMP%20%E6%8C%87%E6%97%A5%E5%8F%AF%E5%BE%85%E3%80%82

https://juejin.cn/post/6844903929717915661