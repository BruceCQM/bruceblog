...
技术选型：
播放器：react-player
地图：小程序使用Taro的Map组件、B端使用react-amap高德地图组件、APP使用了百度地图
富文本编辑器：wang-editor
图表：小程序AntV-F2、B端使用echarts-for-react

https://www.npmjs.com/package/react-player
https://docs.taro.zone/docs/components/maps/map
...
https://f2-v3.antv.vision/zh/docs/tutorial/getting-started
